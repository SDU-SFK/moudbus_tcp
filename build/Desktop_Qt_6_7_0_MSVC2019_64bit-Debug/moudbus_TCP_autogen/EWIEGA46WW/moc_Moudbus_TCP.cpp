/****************************************************************************
** Meta object code from reading C++ file 'Moudbus_TCP.h'
**
...
#error "The header file 'Moudbus_TCP.h' doesn't include <QObject>."
...
void welding_machine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->readIS_finished(); break;
        default: ;
        }
        ...
        {
            using _t = void (welding_machine::*)();
            if (_t _q_method = &welding_machine::readIS_finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 5
void welding_machine::readIS_finished()
{
